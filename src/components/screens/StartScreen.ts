...
export class StartScreen {
  ...
  private static readonly SUBTITLES = [
    ...
    // Pack 2
    'Has perdido contra un bucle for. Reflexiona.',
    'Tu estrategia tiene nombre clínico.',
    'El algoritmo no te odia. Te ignora. Es peor.',
    'Cinco años de tu vida y ni un solo título.',
    'La IA tardó 3ms en destruirte. Fue su warmup.',
    'Fichas mal puestas: todas. Sin excepción.',
    'Tu árbol genealógico llora cada vez que juegas.',
    'Modo Fácil existe por personas como tú.',
    'La IA ha visto mejores jugadas en demos de error.',
    'No es el juego. Eres tú. Definitivamente tú.',
    'Cada movimiento tuyo es un regalo para la IA.',
    'Ni con trampa ganarías. Lo hemos comprobado.',
    'Tu tablero es abstractamente feo.',
    'El pato tiene más coeficiente intelectual que tu fila 3.',
    'Los errores no se borran. Solo se acumulan en tus estadísticas.',
    'La IA te estudió. Eligió no respetarte.',
    'Podrías mejorar. Pero llevas 47 partidas y no ha pasado.',
    'Tus decisiones tácticas son arte moderno: incomprensibles e inútiles.',
    'El leopardo se ríe. El oso asiente. El pato suspira.',
    'Jugaste como si el objetivo fuera perder. Bien hecho.',
    'El bosque ha sobrevivido incendios. No sobrevivirá tu fila 4.',
    'Tu rendimiento estadístico es un insulto a los números.',
    'Has encontrado formas de perder que la IA no tenía catalogadas.',
    'Nadie te obligó a jugar así. Esa es la parte que duele.',
    'El algoritmo tiene más vida social que tú y no sale de un servidor.',
    'Tu colocación de fichas sugiere que odias ganar.',
    'La IA no celebra cuando gana. Tú tampoco tendrías motivos.',
    'Llevas tanto tiempo perdiendo que ya es tu identidad.',
    'Una piedra con ojos jugaría igual. Hemos hecho la prueba.',
    'El juego tiene modo fácil. No hay modo lo suficientemente fácil para ti.',
    'Cinco animales te juzgan simultáneamente. Los cinco tienen razón.',
    'Tu historia de partidas es un documento de duelo.',
    'La IA no aprende de ti. No hay nada que aprender.',
    'Pusiste esa ficha ahí a propósito. Eso lo hace peor.',
    'El conejito te ha perdonado. El oso todavía no.',
    'Tu nivel estratégico es un misterio incluso para la física cuántica.',
    'Cada vez que abres esta app, la IA se frota las manos.',
    'Has igualado el récord de peor apertura. Lo has superado.',
    'Tu tablero en la ronda 2 ya era un caso perdido. Intuición tuya, no.',
    'La IA tiene un fichero especial para tus jugadas. Lo llama "ejemplos negativos".',
    'El bosque florece. Tú no.',
    'Eres la razón por la que existe el modo tutorial.',
    'Tu confianza al inicio de cada partida es lo más valiente de todo esto.',
    'Has perdido de formas que ni el diseñador del juego contempló.',
    'El águila vio tu fila 1. El águila se fue.',
    'Statistically hablando, el azar lo haría mejor que tú.',
    'Llevas jugando el tiempo suficiente para haber aprendido. Y sin embargo.',
    'Tu puntuación final es lo que pasa cuando el optimismo choca con la realidad.',
    'La IA no tiene ego. Contigo no lo necesita.',
    'Bienvenido de vuelta. Sabíamos que volverías. Todos lo sabíamos.',
  ];
